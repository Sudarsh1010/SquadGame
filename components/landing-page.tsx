...
import { GameIcon } from "./game/svgs/game-icon"
...
export function LandingPage({ isConnected, hasInteracted }: LandingPageProps) {
  const getGlitchText = () => {
    if (!isConnected) {
      return hasInteracted ? "Connecting wallet..." : "Click anywhere to connect wallet"
    }
    return "Checking user access..."
  }
