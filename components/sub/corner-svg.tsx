  ...
  const svgContent = {
    ...
    topRight: (
      <svg width="auto" height="auto" viewBox="0 0 353 410" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M262.664 -155L0 299.947H525.327L262.664 -155ZM262.664 17.8798L149.718 213.507H375.609L262.664 17.8798Z" fill="white"/>
      </svg>
    ),
    bottomLeft: (
      <svg width="auto" height="auto" viewBox="0 0 555 557" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M424.677 453.386L159.328 -0.000234091L-100.641 456.492L424.677 453.386ZM274.45 367.832L160.35 172.877L48.5635 369.168L274.45 367.832Z" fill="white"/>
      </svg>
    ),
    bottomRight: (
      <svg width="auto" height="auto" viewBox="0 0 353 410" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    topRightB: (
      <svg width="auto" height="auto" viewBox="0 0 353 410" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M262.664 -155L0 299.947H525.327L262.664 -155ZM262.664 17.8798L149.718 213.507H375.609L262.664 17.8798Z" fill="#215FFF"/>
      </svg>
    ),
    bottomLeftB: (
      <svg width="auto" height="auto" viewBox="0 0 555 557" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M424.677 453.386L159.328 -0.000234091L-100.641 456.492L424.677 453.386ZM274.45 367.832L160.35 172.877L48.5635 369.168L274.45 367.832Z" fill="#215FFF"/>
      </svg>
    ),
    bottomRightB: (
      <svg width="auto" height="auto" viewBox="0 0 353 410" fill="none" xmlns="http://www.w3.org/2000/svg">
